...
generate-proto:
	export PATH="$$PATH:$(GOPATH)/bin" && protoc -I ./api/danielvladco/protobuf -I ./api  --go_out=paths=source_relative:./pkg/graphqlpb ./api/danielvladco/protobuf/graphql.proto
