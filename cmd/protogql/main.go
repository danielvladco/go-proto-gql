...
var (
	...
	useFieldNames = flag.Bool("jsonNames", false, "By default graphql field names are generated by converting the proto field name to camelCase. Set this option to true to use the raw protobuf field name as the graphql field name")
)
...
func main() {
	...
	fatal(err)
	gqlDesc, err := generator.NewSchemas(descs, *merge, *svc, *useFieldNames, p)
	fatal(err)
