...
func (*Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_options_5221aa53235085ef, []int{0}
}
...
func (*Foo2) Descriptor() ([]byte, []int) {
	return fileDescriptor_options_5221aa53235085ef, []int{1}
}
...
func init() { proto.RegisterFile("example/options.proto", fileDescriptor_options_5221aa53235085ef) }

var fileDescriptor_options_5221aa53235085ef = []byte{
