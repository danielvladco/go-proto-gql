...
func (s *ConstructsGQLServer) ConstructsAny(ctx context.Context, in *any.Any) (*Any, error) {
...
type IsOneof1 interface {
	isOneof1()
}
type IsOneof2 interface {
	isOneof2()
}
type IsOneof3 interface {
	isOneof3()
}
