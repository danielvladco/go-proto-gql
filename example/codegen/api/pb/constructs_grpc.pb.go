...
type ConstructsClient interface {
	...
	Any_(ctx context.Context, in *any1.Any, opts ...grpc.CallOption) (*Any, error)
...
func (c *constructsClient) Any_(ctx context.Context, in *any1.Any, opts ...grpc.CallOption) (*Any, error) {
	out := new(Any)
...
type ConstructsServer interface {
	...
	Any_(context.Context, *any1.Any) (*Any, error)
...
func (UnimplementedConstructsServer) Any_(context.Context, *any1.Any) (*Any, error) {
