...
func (c *serviceClient) Ignore(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Data, error) {
	out := new(Data)
	err := c.cc.Invoke(ctx, "/pb.Service/Ignore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) Name(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Data, error) {
	out := new(Data)
	err := c.cc.Invoke(ctx, "/pb.Service/Name", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testClient) Name(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Data, error) {
	out := new(Data)
	err := c.cc.Invoke(ctx, "/pb.Test/Name", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testClient) NewName(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Data, error) {
	out := new(Data)
	err := c.cc.Invoke(ctx, "/pb.Test/NewName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
